  ...
  it("HYBRID · cols[drawers | door]", () => { expect(snap(mk({ kind: "base", w: 800, h: 720, fill: "shelves", count: 2, door: 0, layout: { split: "cols", sizes: [0.5, 0.5], children: [{ split: "rows", sizes: [1, 1, 1], children: [{ front: "drawer" }, { front: "drawer" }, { front: "drawer" }] }, { front: "door" }] } }))).toMatchInlineSnapshot(`
    {
      ...
      "cut": [
        ...
        "Перегородка · ЛДСП 16мм, белый · 376×560×16",
        "Перегородка · ЛДСП 16мм, белый · 376×560×16",
        "Ящик · фасад · МДФ фасад фрезерованный 18мм · 200×400×18",
        "Ящик · бок Л · ЛДСП 16мм, белый · 528×168×16",
        "Ящик · бок П · ЛДСП 16мм, белый · 528×168×16",
        "Ящик · задняя · ЛДСП 16мм, белый · 318×168×16",
        "Ящик · дно · ЛДСП 16мм, белый · 318×528×16",
        "Ящик · фасад · МДФ фасад фрезерованный 18мм · 200×400×18",
        "Ящик · бок Л · ЛДСП 16мм, белый · 528×168×16",
        "Ящик · бок П · ЛДСП 16мм, белый · 528×168×16",
        "Ящик · задняя · ЛДСП 16мм, белый · 318×168×16",
        ...
        "Полка · ЛДСП 16мм, белый · 376×560×16",
        "Полка · ЛДСП 16мм, белый · 376×560×16",
      ],
      "hardware": [
        "Петля накладная с доводчиком ×2",
